...
urlpatterns = [
    ...
    path('building/<int:building_id>/', views.college.BuildingDetailed.as_view(), name="building"),
    path('building/<int:building_id>/rooms', views.calendar.building_schedule_rooms_view, name="building_schedule_rooms"),
    ...
    path('class/<int:class_id>/', views.college.ClassDetailed.as_view(), name="class"),
    ...
    path('department/<int:department_id>/class_instances/',
         views.college.DepartmentClassInstances.as_view(),
         name="department_class_instances"),
    # Chat
