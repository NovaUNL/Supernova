...
def append_shift_instances(destination, instances, weekday_occurrences):
    """
    Appends occurrences (in extension) of a set of shift instances in the provided days in the weekday bi-dimentional
    ...
    :param instances: Collection of ShiftInstance objects
    ...
    for instance in instances:
        ...
        title = f'{instance.shift.class_instance.parent.abbreviation} {instance.shift.get_shift_type_display()}'
