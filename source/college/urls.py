...
urlpatterns = [
    ...
    path('campus/edificio/<int:building_id>/nova_sala', views.room_create_view, name='room_create'),
    path('sala/<int:room_id>/', views.room_view, name='room'),
    path('sala/<int:room_id>/editar', views.room_edit_view, name='room_edit'),
    ...
    path('cadeira/i/<int:instance_id>/turno/<int:shift_id>',
         views.class_instance_shift_view,
         name='class_instance_shift'),
    ...
    path('cadeira/i/<int:instance_id>/avaliar', views.class_instance_review_create_view,
         name='class_instance_review_create'),
    ...
    path('cadeira/i/<int:instance_id>/ficheiros/editar',
         views.class_instance_files_edit_view,
         name='class_instance_files_edit'),
    path('cadeira/i/<int:instance_id>/ficheiros/anexar',
         views.class_instance_file_attach_view,
         name='class_instance_file_attach'),
    path('cadeira/i/<int:instance_id>/ficheiros/anexar/<str:file_hash>',
         views.class_instance_file_attach_view,
         name='class_instance_new_file_attach'),
    path('cadeira/i/<int:instance_id>/ficheiro/<int:class_file_id>/editar',
         views.class_instance_file_edit_view,
         name='class_instance_file_edit'),
    path('cadeira/i/<int:instance_id>/ficheiro/<str:class_file_id>',
         views.class_instance_file_view,
         name='class_instance_file'),
    path('cadeira/i/<int:instance_id>/ficheiro/<str:class_file_id>/download',
         views.class_instance_file_download,
         name='class_instance_file_download'),
    path('ficheiro/<str:file_hash>/', views.file_view, name='file'),
    path('ficheiro/<str:file_hash>/editar', views.file_edit_view, name='file_edit'),
    path('ficheiro/<str:file_hash>/download', views.file_download, name='file_download'),
